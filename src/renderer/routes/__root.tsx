...
function Root() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      // Skip guide-related checks if already on guide, settings/mcp, or chatbridge page
      if (location.pathname === '/guide' || location.pathname === '/settings/mcp' || location.pathname.startsWith('/chatbridge')) {
